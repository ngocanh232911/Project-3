...
const Cart = () => {
  ...
  const handleCheckout = () => {
    if (totalAmount === 0) {
      // setCheckoutMessage("Not Enough Balance");
      navigate("/cart"); // Set message if subtotal is 0
    } else {
      // setCheckoutMessage(""); // Clear message
      navigate("/checkout"); // Proceed to checkout if subtotal is not zero
    }
  };
